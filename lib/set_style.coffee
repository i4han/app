...
@brand-primary:         red; //# #D9230F;
@brand-success:         red; //# #469408;
@brand-info:            #029ACF;
...
@btn-default-color:              @brand-primary; //# #fff;
@btn-default-bg:                 #474949;
@btn-default-border:             white; //# @btn-default-bg;
