...
var bigButton, calendar_size, date_box_size, fullscreen, fullsize, fym, windowFit;
...
windowFit = function(options) {
  var window_height, window_width;
  if (options.style && (window_width = $(window).width()) / (window_height = $(window).height()) > options.radio) {
...
module.exports.index = {
  ...
  main: {
    ...
    absurd: function() {
      return {
        ...
        screen0: [fullscreen(-10), fullsize(), this.Settings.screen_bg],
        video0: {
          height: 50
        },
        '#bg-video': [
    ...
    onRendered: function(name) {
      ...
      this.$video = $(video).insertAfter(m.id('video0'));
  ...
  history: {
    ...
    HTML: "<a class=\"twitter-timeline\" href=\"https://twitter.com/hashtag/calgary\" data-widget-id=\"589270954393489408\">#calgary Tweets</a>\n<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+\"://platform.twitter.com/widgets.js\";fjs.parentNode.insertBefore(js,fjs);}}(document,\"script\",\"twitter-wjs\");</script>"
  },
  location: {
    lable: 'Locations',
    router: {
  ...
  map: {
    ...
    onRendered: function() {
      ...
      return x.timeout(10, Module.map.map_init);
    },
    map_init: function() {
  ...
  day: {
    collection: 'calendar',
    jade: function() {
      return 'init title date day event'.split(' ').map(function(c) {
        return "." + c + " {{" + c + "}}";
      }).join('\n');
    },
    helpers: {
  ...
  popover_name: {
    jade: {
      ul: ['li Write your name.', 'li No longer then 12 letters.']
    }
  },
  popover_phone: {
    jade: {
