...
local = {
  ...
  navbar: {
    list: typeof Meteor === "undefined" || Meteor === null ? index.layout.jade.match(/\+navbar\(.*list=\s*"([^"]*)".*\)/)[1].split(' ') : null,
    style: typeof Meteor === "undefined" || Meteor === null ? index.layout.jade.match(/\+navbar\(.*style=\s*"([^"]*)".*\)/)[1] : null
  }
};
