...
#        __.set('inChangePasswordFlow', true) # remove
...
Template._loginButtonsLoggedIn.dropdown = -> Accounts.loginButtons.dropdown()
...
Template._loginButtonsLoggedInDropdownActions.additionalLoggedInDropdownActions = ->
...
Template._loginButtonsLoggedOutDropdown.forbidClientAccountCreation = -> Accounts._options.forbidClientAccountCreation
...
Template._loginButtonsMessagesDialog.visible = ->
  hasMessage = __.get('infoMessage') || __.get('errorMessage')
  !Accounts.loginButtons.dropdown() && hasMessage
